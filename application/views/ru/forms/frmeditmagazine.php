<?=form_open($this->uri->uri_string(),array('class'=>'form-horizontal')); ?>
	...
	<fieldset>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span5 input-valid" name="title" value="<?=$shop['title'];?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span5 input-valid" name="address" value="<?=$shop['address'];?>">
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span5 input-valid" name="phones" value="<?=$shop['phones'];?>">
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<select class="span4" name="type" id="ShopType">
					<option value="1">Фирменный магазин</option>
					<option value="2">Сетевой магазин</option>
				</select>
			</div>
		</div>
	</fieldset>
