<?=form_open_multipart($this->uri->uri_string(),array('class'=>'form-horizontal')); ?>
	<legend>Форма редактирования цитаты</legend>
	<fieldset>
		<div class="control-group">
			<label for="name" class="control-label">Инициалы: </label>
			<div class="controls">
				<input type="text" class="span5 input-valid" name="name" value="<?=$quote['name'];?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea rows="10" class="span7 input-valid redactor" name="text"><?=$quote['text'];?></textarea>
				<span class="help-inline" style="display:none;">&nbsp;</span>
			</div>
		</div>
	</fieldset>
