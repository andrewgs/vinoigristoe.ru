	...
	<div class="container" class="cf">
			...
			<div id="main" role="main">
				<section class="company-page cf">
					<h2>
						Увлекательный день с посещением производства и виноградников Цимлянских вин 
					</h2>
					<div class="ornament-sep"> </div>
					<div class="column">
						<p class="pt1em">
							Компания «Цимлянские вина» совместно с туристической компанией Орион предлагают 
							Вам провести увлекательный день с Цимлянскими винами <br />
							и посетить наше производство и виноградники, <br />
							а также продегустировать нашу продукцию.
						</p>
				...
				<section class="tourism company-page cf">
					<div class="column">
						...
						<p class="solid">
							Контактный телефон турагентства Орион <br /> +7 (918) 520-43-88
						</p>						
					</div>
					<div class="column">
